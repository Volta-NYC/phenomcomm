...
export const metadata: Metadata = {
  ...
  description:
    "Close the gap between knowing and doing. PhenomComm helps leaders, teams, and organizations build lasting performance through The Upgrade Framework™.",
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: site.name,
    images: [
      { url: "/opengraph-image.png", width: 1200, height: 630, alt: "PhenomComm. Talent development that works." },
    ],
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: site.url,
              logo: `${site.url}/images/phenomcomm-logo.webp`,
              email: site.email,
              telephone: "+18038750525",
              founder: { "@type": "Person", name: "Paulette Cunningham" },
